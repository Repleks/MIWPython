...
poly_features = PolynomialFeatures(degree=2) #PolynomialFeatures()
X_train_poly = poly_features.fit_transform(X_train) # Przekształcamy dane treningowe
X_test_poly = poly_features.transform(X_test) # Przekształcamy dane testowe
